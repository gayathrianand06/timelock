...
contract('HashTimelockWrapper', accounts => {
  ...
  it('refund() in wrapper should pass after timelock expiry', async () => {
    const hashPair = newSecretHashPair()
    const htlcWrapper = new HtlcWrapper(HashTimelock, provider, null)
  ...
  it('retrieve contract from address in wrapper', async () => {
    ...
    const address = await HtlcWrapper.deployContract(HashTimelock, null, null)
